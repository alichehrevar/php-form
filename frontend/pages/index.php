...
<div class="bg-white flex flex-col p-8 rounded-2xl shadow-xl w-full max-w-md">
    ...
    <a href="#" target="_blank" type="button" class="mt-6 text-center flex items-center justify-center gap-2 bg-gray-800 text-white py-2 rounded-lg text-lg font-medium hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-700">
